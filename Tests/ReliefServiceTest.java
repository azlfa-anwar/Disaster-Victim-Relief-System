...
public class ReliefServiceTest {
    ...
    public void testGetDateOfInquiry() {
        LocalDate expectedDate = LocalDate.parse(validDate, DateTimeFormatter.ISO_DATE);
        assertEquals("Date of inquiry should match the one set in setup", expectedDate,
    ...
    public void testSetDateOfInquiryWithValidDate() {
        // Create a valid LocalDate object
        LocalDate validLocalDate = LocalDate.parse(validDate, DateTimeFormatter.ISO_DATE);
        reliefService.setDateOfInquiry(validLocalDate);
        assertEquals("Setting a valid date should update the date of inquiry", validLocalDate,
                reliefService.getDateOfInquiry());
    }
